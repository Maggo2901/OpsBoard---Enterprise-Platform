        ...
        <>
            ...
            {isOpen && createPortal(
                <div
                    ref={panelRef}
                    className={cn(
                        'fixed w-[300px] rounded-xl border border-[rgba(124,156,255,0.24)] bg-slate-900/95 backdrop-blur-md',
                        'shadow-[0_24px_48px_-24px_rgba(0,0,0,0.95),0_0_0_1px_rgba(110,160,255,0.18)] z-[10050]',
